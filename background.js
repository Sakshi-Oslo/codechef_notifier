...
function getResult(ques) {
    $.ajax({
        url: "https://www.codechef.com/get_submission_status/" + ques.id + "/",
        dataType: "json",
        success: function(r) {
            if (r.result_code != "wait") {
                ...
                switch (s) {
                    case "partial_accepted":
                        ...
                        op.iconUrl = "/images/pcorrect_chef_128.png";
                        break;
                    ...
                    case "accepted":
                        ...
                        table += "<tr><th></th><th></th><th>Total Score = 100.00%<br/></th></tr>";
                        break;
                    ...
                    case "wrong":
                        ...
                        table += "<tr><th></th><th></th><th>Total Score =0.00%<br/></th></tr>";
                        break;
                    ...
                    case "score":
                        res.verdict = "Insufficient Score";
                        op.items.push({ title: "Verdict: ", message: "Insufficient Score!!" });
                        op.iconUrl = "/images/wrong_chef_128.png";
                        break;

                    case "error":
                        res.verdict = "Internal Error";
